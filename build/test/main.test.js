...
ava_1["default"](
  "it should add pending transaction, return an array with length of 2 and be truthy for special cases",
  function (t) {
    ...
    log(
      "Txn Hash tree ==> " +
        JSON.stringify(
          lodash_1["default"].map(subject, function (tx) {
            return tx.hash;
          }),
          null,
          2
    ...
    t.is(
      lodash_1["default"].get(lodash_1["default"].head(subject), "coinbase"),
      true
    );
    t.is(
      lodash_1["default"].get(lodash_1["default"].head(subject), "type"),
      enums_1.TransactionTypes.CRYPTO
    );
  }
);
...
ava_1["default"]("chain is valid", function (t) {
  return t["true"](chain.chainIsValid());
});
